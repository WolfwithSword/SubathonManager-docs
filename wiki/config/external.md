...
-   :material-storefront-outline: **GoAffPro**

    ---

    Connect and configure GoAffPro for merch store integrations, such as GamerSupps, UwUMarket, and Orchid Eight.

    [:octicons-arrow-right-24: GoAffPro Config](setup/GoAffPro.md)

-   :material-coffee: **KoFi**

    ---

    Connect and configure KoFi donations and memberships.
